...
import { createPost, createPostGroup, PostGroupData } from '@/app/api/postService';
...
const CreatePostPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const data = await createPostGroup(postData);
      console.log("Post created successfully:", data);

      toast({
        title: "Post Created",
        description: "Your plant post has been successfully created!, wating for admin approval",
        variant: "success"
      });
